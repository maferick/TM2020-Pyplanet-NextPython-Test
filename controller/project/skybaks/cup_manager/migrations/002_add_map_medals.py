...
def upgrade(migrator: SchemaMigrator) -> None:
    ...
    migrate(
        migrator.add_column(MatchInfo._meta.table_name, "medal_author", medal_author),
        migrator.add_column(MatchInfo._meta.table_name, "medal_gold", medal_gold),
        migrator.add_column(MatchInfo._meta.table_name, "medal_silver", medal_silver),
        migrator.add_column(MatchInfo._meta.table_name, "medal_bronze", medal_bronze),
    )
