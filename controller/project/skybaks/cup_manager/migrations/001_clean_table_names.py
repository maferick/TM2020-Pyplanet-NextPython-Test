    ...
    try:
        ...
        if "cup_manager_cupinfo_v1" in current_tables:
            if (
                ...
                and "cup_manager_cupinfo" == CupInfo._meta.table_name
            ):
                CupInfo.drop_table()
            migrate(
        ...
        if "cup_manager_cupmatch_v1" in current_tables:
            if (
                ...
                and "cup_manager_cupmatch" == CupMatch._meta.table_name
            ):
                CupMatch.drop_table()
            migrate(
        ...
        if "cup_manager_matchinfo_v1" in current_tables:
            if (
                ...
                and "cup_manager_matchinfo" == MatchInfo._meta.table_name
            ):
        ...
        if "cup_manager_playerscore_v2" in current_tables:
            if (
                ...
                and "cup_manager_playerscore" == PlayerScore._meta.table_name
            ):
