...
class Storage(StorageInterface):
	...
	async def open(self, file: str, mode: str = 'rb', **kwargs):
		...
		:return: File handler.
		"""
		async with self._driver.open(file, mode, **kwargs) as fh:
			yield fh
	...
	async def open_match_settings(self, file: str, mode: str = 'r', **kwargs):
		...
		:return: File handler.
		"""
		async with self._driver.open('{}/{}'.format(self.MATCHSETTINGS_FOLDER, file), mode, **kwargs) as fh:
			yield fh
	...
	async def open_map(self, file: str, mode: str = 'rb', **kwargs):
		...
		:return: File handler.
		"""
		async with self._driver.open('{}/{}'.format(self.MAP_FOLDER, file), mode, **kwargs) as fh:
			yield fh
