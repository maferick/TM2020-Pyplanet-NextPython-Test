...
class ManagementUtility:
	...
	def execute(self):
		...
		if sys.version_info < (3, 11):
			print('WARNING')
			print('WARNING: Your Python version is not officially supported by PyPlanet, please upgrade to Python 3.11 or newer!')
			print('WARNING')
		if sys.version_info >= (3, 14):
			print('WARNING')
			print('WARNING: Your Python version is untested with PyPlanet, you may run into issues!')
			print('WARNING')
